...
local numImages             = 100;  --Total number of frames in dataset
...
local imageInputPath        = scratchPath .. "/data/starFieldpvp/" .. "move_by_alpha7-7.pvp";
local outputPath            = "/nh/compneuro/scratch/starOut/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion .. "7-15-17";
