package.path = package.path .. ";" .. "/home/ssmith/OpenPV/parameterWrapper/?.lua"; local pv = require "PVModule";
...
local tiers                 = 1; --changed to 1 for speed
local stride                = {};
...
local sizeBase              = 8*2*1; -- overcompleteness * rectification * RGB
...
local numImages             = 470;  --Total number of frames in dataset
...
local runName               = "train";
local runVersion            = 1;
local scratchPath           = "/home/ssmith/Star-Field-Transformations";
...
local imageInputPath        = scratchPath .. "/data/starFieldpvp/" .. "move_by_alpha8-1.pvp";
local outputPath            = "/nh/compneuro/scratch/starOut/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion .. "8-01-17_3";
local initPath              = scratchPath .. "/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion-1;
if runVersion == 1 then
   initPath = "/nh/compneuro/scratch/starOut/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion .. "8-01-17_2";   
end
local initializeFromCheckpointDir = nil;
if initPath then
   lastCheckpoint = 10000;
   initializeFromCheckpointDir = initPath .. "/Checkpoints/Checkpoint00" .. lastCheckpoint;
end
local checkpointPeriod = (displayPeriod * displayMultiple * 10);

local momentumTau           = 20;

local VThreshBase           = 0.05;
...
for muggleFlag = 0, 1 do
   ...
   for i_tier = 1, tiers do
	 ...
	 if muggleFlag == 1 then
	    ...
	    pvParams[errorLayerX].triggerOffset                       = 1;
	 ...
	 for i_frame = 1, numFrames - frame_offset, frame_stride do
	    ...
	    if muggleFlag == 1 then
	       ...
	       pvParams[errorDCALayerX].triggerOffset                       = 1;
	 ...
	 pv.addGroup(pvParams,
			...
			updateGpu                           = false;
			dataType                            = nil;
                        originalLayerName                   = lcaLayer .. "_" .. i_frame-1;
		    }
	 )
	 if not immediateLayerPublish and equalPhaseFlag then
	 ...
	 if muggleFlag == 1 then
	    ...
	    pvParams[lcaLayerDiff .. "_" .. i_frame-1].triggerOffset                       = 1;
