...
local numImages             = 200;  --Total number of frames in dataset
...
local imageInputPath        = scratchPath .. "/data/starFieldpvp/" .. "variable_speeds_6-30.pvp";
local outputPath            = "/nh/compneuro/scratch/starOut/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion .. "7-5-17";
