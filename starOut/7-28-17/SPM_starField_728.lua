...
local numImages             = 398;  --Total number of frames in dataset
...
local outputPath            = "/nh/compneuro/scratch/starOut/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion .. "7-28-17";
