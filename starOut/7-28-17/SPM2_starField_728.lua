...
local nbatch                = 16;--8      --24 Batch size
local batchwidth            = 1;
local startFrame            = 1;
...
local numImages             = 396;  --Total number of frames in dataset
...
local imageInputPath        = scratchPath .. "/data/starFieldpvp/" .. "move_by_alpha7-28.pvp";
local outputPath            = "/nh/compneuro/scratch/starOut/" .. expName .. "_" .. numFrames .. "_" .. displayPeriod*displayMultiple .."/" .. runName .. runVersion .. "7-29-17";
...
local baseTau               = math.floor(4000/4);
